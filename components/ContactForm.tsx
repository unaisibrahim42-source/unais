...
export default function ContactForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!FORMSPREE_ID) {
      ...
      window.location.href = `mailto:Contact@Elevatemarketinguk.com?subject=${subject}&body=${body}`;
      setStatus("sent");
      form.reset();
      return;
    }
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {status === "sent" && (
        <p className="text-sm text-white/50">
          ...
          Email <a className="text-accent" href="mailto:Contact@Elevatemarketinguk.com">Contact@Elevatemarketinguk.com</a> directly.
        </p>
      )}
